...
int main()
{
    ...
    double** force_on_cent = new double*[N_samp];
    ...
    double* corr_tot = new double[N_samp];
    ...
    for (int rep = 0 ; rep < N_samp ; ++rep)
    {
        ...
        {
            cent_const_bead(restrained_bead, time, O_T, x_0, v_0, alpha);
            
            force_on_cent[rep][time] = 0.0;
            for (int k = 0 ; k < P ; ++k)
            {
